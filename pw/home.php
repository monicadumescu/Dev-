				...
				if ($conn->connect_error) {
                 die("Connection failed: " . $conn->connect_error);
				  ...
				  if($count >0)
				  {
					  ...
					  {
						      $s=$row['files']; 
							  echo  "</div>", "<div class='div2'><style> .div2 { border-style:groove;}</style>" ,'<img src="'.$s.'" alt="HTML5 Icon" style="width:500px;height:500px"><br>Category: ',
							  $row["name"]," <br>Price: ", $row['price'],"<br>Size: ", $row['si_ze'],"<br>Description: ", $row['description'], "<br><button class='btn btn-outline-success my-2 my-sm-1'  type='submit'>Add to chart</button></br><br>";
					  }
				  }
				  else
				  {
